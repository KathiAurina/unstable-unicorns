...
function leave(G, ctx, param) {
    ...
    on.forEach(card => {
        ...
        const on = (_a = card.on) === null || _a === void 0 ? void 0 : _a.find(o => o.trigger === "unicorn_leaves_your_stable");
...
function enter(G, ctx, param) {
    ...
    const cardOnEnter = (_a = card.on) === null || _a === void 0 ? void 0 : _a.filter(c => c.trigger === "enter");
    if (cardOnEnter) {
        // all unicorns are basic
        // trigger no effect
        if (G.playerEffects[param.playerID].find(s => s.effect.key === "my_unicorns_are_basic")) {
    ...
    on.forEach(card => {
        ...
        const on = (_a = card.on) === null || _a === void 0 ? void 0 : _a.find(o => o.trigger === "unicorn_enters_your_stable");
        if (on.do.type === "inject_action") {
            const newAction = {
                type: "action",
                instructions: [{
...
function executeDo(G, ctx, instructionID, param) {
    var _a;
    const [scene, action, instruction] = (0, exports._findInstructionWithID)(G, instructionID);
...
function destroy(G, ctx, param) {
    ...
    const ons = (_a = card.on) === null || _a === void 0 ? void 0 : _a.filter(on => on.trigger === "this_destroyed_or_sacrificed");
    ons === null || ons === void 0 ? void 0 : ons.forEach(on => {
        // all unicorns are basic
        // trigger no effect
...
// Helper
//
const _findInstructionWithID = (G, instructionID) => {
    let scene = null;
    let action = null;
